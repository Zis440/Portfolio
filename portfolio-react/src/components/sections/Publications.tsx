...
export default function Publications() {
  const publications = [
    { year: "2025", journal: "Web 6.0 & Industry 6.0", title: "Multi‑Modal AI for Mental Health Prediction and Intervention", desc: "A multimodal AI framework combining text, behavioral, and emotional data for early mental health assessment.", color: "from-primary to-accent" },
    { year: "2025", journal: "Prantik Gabeshana Patrika (ISSN 2583-6706)", title: "LID‑R: AI‑Based Object Reshaper", desc: "An AI‑driven system for adaptive reshaping and transformation of geometric and mathematical 3D structures.", color: "from-accent to-primary" },
    { year: "2026", journal: "IEEE ICAECT 2026", title: "GenX: AI‑Powered Genomic Hybridization Analysis and Prediction", desc: "A genomic hybridization simulation framework using DNA sequence merging algorithms and predictive biological modelling.", color: "from-primary via-accent to-primary" }
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {publications.map((pub, idx) => (
            <motion.div key={idx} initial={{ opacity: 0, y: 30, scale: 0.95 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.6, delay: idx * 0.12 }}
              whileHover={{ y: -8 }}
              className="group relative shimmer-on-hover"
            >
